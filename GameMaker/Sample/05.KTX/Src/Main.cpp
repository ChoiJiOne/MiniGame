...
int32_t WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR pCmdLine, _In_ int32_t nCmdShow)
{
	...
	GameMaker::GameEngine::Init({ "05.KTX", 100, 100, 800, 600, false, false });
	...
	GameMaker::Shader* shader = GameMaker::ResourceManager::Get().Create<GameMaker::Shader>(
		"GameMaker/Sample/05.KTX/Res/Shader.vert",
		"GameMaker/Sample/05.KTX/Res/Shader.frag"
	);

	GameMaker::Texture2D* texture = GameMaker::ResourceManager::Get().Create<GameMaker::Texture2D>("GameMaker/Sample/05.KTX/Res/awesomeface.ktx", true);
